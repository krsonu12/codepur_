...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [facebookLogo, google, welcome];
}

class $AssetsSvgGen {
  const $AssetsSvgGen();

  /// File path: assets/svg/home_screen.svg
  String get homeScreen => 'assets/svg/home_screen.svg';

  /// File path: assets/svg/login_image.svg
  String get loginImage => 'assets/svg/login_image.svg';

  /// File path: assets/svg/onboarding.svg
  String get onboarding => 'assets/svg/onboarding.svg';

  /// List of all assets
  List<String> get values => [homeScreen, loginImage, onboarding];
}
